...
public final class Environment {
	...
	public static final void setTemperature(double t) {
		...
		p.setValue(t);
		EnvironmentEvent ev = Event.newEvent(EnvironmentEvent.class, "temperature", settings.replace("temperature", p));
		...
		mp.calc();
		ev = Event.newEvent(EnvironmentEvent.class, "gasmolv", mp);
		AbstractContainer.CHEMICAL_BUS.post(ev);
		Event.free(ev);
	}
	...
	public static final void setPressure(double t) {
		DoubleProperty p = new DoubleProperty();
		p.setValue(t);
		EnvironmentEvent ev = Event.newEvent(EnvironmentEvent.class, "pressure", settings.replace("pressure", p));
		AbstractContainer.CHEMICAL_BUS.post(ev);
		Event.free(ev);
		MathStatementProperty mp = (MathStatementProperty) settings.get("gasmolv");
		mp.setValue("T", getTemperature());

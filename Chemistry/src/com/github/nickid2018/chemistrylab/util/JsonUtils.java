...
public class JsonUtils {
	...
	@SuppressWarnings("unchecked")
	public static <T> T fromJson(Gson gsonIn, Reader readerIn, Type adapter, boolean lenient) {
		try {
			JsonReader jsonreader = new JsonReader(readerIn);
			jsonreader.setLenient(lenient);
			return (T) gsonIn.getAdapter(TypeToken.get(adapter)).read(jsonreader);
		} catch (IOException ioexception) {
			throw new JsonParseException(ioexception);
		}
	}
	...
	public static <T> T fromJson(Gson gsonIn, String s, Type adapter, boolean lenient) {
		return (T) fromJson(gsonIn, new StringReader(s), adapter, lenient);
	}
	...
	public static <T> T fromJson(Gson gsonIn, Reader readerIn, Type adapter) {
		return (T) fromJson(gsonIn, readerIn, adapter, false);
	}
	...
	public static <T> T fromJson(Gson gsonIn, Reader readerIn, Class<T> adapter) {
		return (T) gsonDeserialize(gsonIn, readerIn, adapter, false);
	}

...
public class FriendlyByteBuf extends ByteBuf {
    ...
    public FriendlyByteBuf(ByteBuf paramByteBuf) {
    ...
    public <T, C extends Collection<T>> C readCollection(IntFunction<C> paramIntFunction,
                                                         Function<FriendlyByteBuf, T> paramFunction) {
        int i = readVarInt();
    ...
    public <T> void writeCollection(Collection<T> paramCollection, BiConsumer<FriendlyByteBuf, T> paramBiConsumer) {
        writeVarInt(paramCollection.size());
        for (T obj : paramCollection)
            paramBiConsumer.accept(this, obj);
    }

    public <T> List<T> readList(Function<FriendlyByteBuf, T> paramFunction) {
        return readCollection(Lists::newArrayListWithCapacity, paramFunction);
    }
    ...
    public <K, V, M extends Map<K, V>> M readMap(IntFunction<M> paramIntFunction,
                                                 Function<FriendlyByteBuf, K> paramFunction, Function<FriendlyByteBuf, V> paramFunction1) {
        int i = readVarInt();
    ...
    public <K, V> Map<K, V> readMap(Function<FriendlyByteBuf, K> paramFunction,
                                    Function<FriendlyByteBuf, V> paramFunction1) {
        return readMap(Maps::newHashMapWithExpectedSize, paramFunction, paramFunction1);
    }

    public <K, V> void writeMap(Map<K, V> paramMap, BiConsumer<FriendlyByteBuf, K> paramBiConsumer,
                                BiConsumer<FriendlyByteBuf, V> paramBiConsumer1) {
    ...
    public void readWithCount(Consumer<FriendlyByteBuf> paramConsumer) {
        int i = readVarInt();
        for (byte b = 0; b < i; b++)
            paramConsumer.accept(this);
    }

    public <T> void writeOptional(Optional<T> paramOptional, BiConsumer<FriendlyByteBuf, T> paramBiConsumer) {
    ...
    public <T> Optional<T> readOptional(Function<FriendlyByteBuf, T> paramFunction) {
    ...
    public FriendlyByteBuf writeByteArray(byte[] paramArrayOfbyte) {
    ...
    public FriendlyByteBuf writeVarIntArray(int[] paramArrayOfint) {
    ...
    public FriendlyByteBuf writeLongArray(long[] paramArrayOflong) {
    ...
    public FriendlyByteBuf writeEnum(Enum<?> paramEnum) {
    ...
    public FriendlyByteBuf writeUUID(UUID paramUUID) {
    ...
    public FriendlyByteBuf writeVarInt(int paramInt) {
        while (true) {
    ...
    public FriendlyByteBuf writeVarLong(long paramLong) {
        while (true) {
    ...
    public String readUtf(int paramInt) {
        int i = readVarInt();
        if (i > paramInt * 4)
        ...
        String str = toString(readerIndex(), i, Charsets.UTF_8);
    ...
    public FriendlyByteBuf writeUtf(String paramString) {
        return writeUtf(paramString, 32767);
    }

    public FriendlyByteBuf writeUtf(String paramString, int paramInt) {
    ...
    public FriendlyByteBuf writeDate(Date paramDate) {

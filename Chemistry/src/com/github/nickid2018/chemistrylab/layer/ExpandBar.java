...
public class ExpandBar extends Layer {
	...
	public ExpandBar() {
		super(0, MainWindow.nowHeight / 2 - 20, 21, MainWindow.nowHeight / 2 + 20);
	}
...
//		new Color(150, 150, 150, 75).bind();
		glBegin(GL_QUADS);
		glVertex2f(0, MainWindow.nowHeight / 2 - 20);
		glVertex2f(21, MainWindow.nowHeight / 2 - 20);
		glVertex2f(21, MainWindow.nowHeight / 2 + 20);
		glVertex2f(0, MainWindow.nowHeight / 2 + 20);
		glEnd();
//		new Color(255, 255, 255, 128).bind();
		glBegin(GL_QUADS);
		glVertex2f(1, MainWindow.nowHeight / 2 - 19);
		glVertex2f(4, MainWindow.nowHeight / 2 - 19);
		glVertex2f(19, MainWindow.nowHeight / 2);
		glVertex2f(16, MainWindow.nowHeight / 2);
		glEnd();
		glBegin(GL_QUADS);
		glVertex2f(16, MainWindow.nowHeight / 2);
		glVertex2f(19, MainWindow.nowHeight / 2);

...
//			CommonRender.drawRightFont("LWJGL version " + Version.getVersion(), Window.nowWidth, next, 16, Color.white,
//					true);
...
//					"OpenAL version " + SoundSystem.getALVersion() + " ALC " + SoundSystem.getALCVersion(),
//					Window.nowWidth, next * 4, 16, Color.white, true);
//
//			try {
//				CpuInfo[] info = sigar.getCpuInfoList();
//				CommonRender.drawRightFont("CPU:" + info[0].getVendor() + " " + info[0].getModel(), Window.nowWidth,
//						next * 5, 16, Color.white, true);
//			} catch (SigarException e) {
//				CommonRender.drawRightFont("CPU:Cannot get information about CPU", Window.nowWidth, next * 5, 16,
//						Color.red, true);
//			}
//			CommonRender.drawRightFont("Now Resolution: " + Window.nowWidth + " x " + Window.nowHeight, Window.nowWidth,
//					next * 6, 16, Color.white, true);
...
//			CommonRender.drawRightFont("Temperature: " + Environment.getTemperature() + "K", Window.nowWidth, next * 9,
//					16, Color.white, true);

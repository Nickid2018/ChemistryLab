...
import io.github.nickid2018.chemistrylab.Bootstrap;
import io.github.nickid2018.chemistrylab.annotation.API;
import io.github.nickid2018.chemistrylab.annotation.ScriptAPI;
import io.github.nickid2018.chemistrylab.client.network.ClientLoginNetworkHandler;
...
import io.github.nickid2018.chemistrylab.mod.javascript.JavaScriptModBase;
...
import io.github.nickid2018.chemistrylab.network.handler.PacketDecoder;
import io.github.nickid2018.chemistrylab.network.handler.PacketEncoder;
import io.github.nickid2018.chemistrylab.network.handler.SizePrepender;
import io.github.nickid2018.chemistrylab.network.handler.SplitterHandler;
...
import io.github.nickid2018.chemistrylab.server.network.ServerLoginPacketHandler;
...
public class ServerNetworkStarter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        base.init();
        base.evalString("""
            array = [100, 200, 50, 1, 114, 514, 1919, 810];
            if (importSystemPackage("utils")) {
                var comparator = function(v1, v2) {
                    return v1 - v2;
                };
                sortWithComparator(array, comparator);
                logInfo(binarySearch(array, 114));
            }
        """);
